...
from test_4c import evaluate_4c
...
# CUDA_VISIBLE_DEVICES=1 python train_4c.py
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_def", type=str, default="config/yolov3-custom_4c.cfg", help="path to model definition file")  # yolo 配置文件路径
    parser.add_argument("--data_config", type=str, default="config/custom_4c.data", help="path to data config file")  # 也是配置文件，配置类别数、训练和测试集路径、类别名称文件路径等
    ...
    parser.add_argument("--checkpoint_folder", default="checkpoints/4c/", help="the folder to store checkpoints")  # added by Alex
